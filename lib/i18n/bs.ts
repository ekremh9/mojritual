...
export const bs = {
  ...
  email: {
    ...
    resetLozinke: {
      preview: 'Zahtjev za reset lozinke na Ritualu',
      pozdrav: (ime: string) => `Zdravo, ${ime}!`,
      tekstZahtjev:
        'Zatraženo je resetovanje lozinke za vaš Ritual nalog. Kliknite dugme ispod da postavite novu lozinku.',
      napomenaIsticanje: 'Link ističe za 1 sat.',
      napomenaIgnorisi:
        'Ako niste vi zatražili ovo, slobodno ignorišite ovaj email — vaša lozinka ostaje nepromijenjena.',
  ...
  prijava: {
    ...
    zaboravioLozinku: 'Zaboravljena lozinka?',
    greskaKredencijali: 'Neispravan email ili lozinka.',
    greskaOpsta: 'Došlo je do greške. Pokušaj ponovo.',
    resetUspjeh: 'Lozinka je promijenjena. Prijavi se sa novom lozinkom.',
  },
  zaboravljenaLozinka: {
    naslov: 'Zaboravljena lozinka',
    podnaslov: 'Unesi email adresu i poslat ćemo ti link za resetovanje lozinke.',
    email: 'Email',
    emailPlaceholder: 'vas@email.com',
    dugme: 'Pošalji link',
    dugmeUcitavanje: 'Slanje…',
    uspjeh: 'Ako nalog postoji, poslali smo link na taj email.',
  ...
  resetLozinke: {
    naslov: 'Nova lozinka',
    podnaslov: 'Postavi novu lozinku za svoj nalog.',
    lozinka: 'Nova lozinka',
    lozinkaPomoc: 'Najmanje 8 karaktera.',
    potvrdaLozinke: 'Potvrdi lozinku',
    dugme: 'Sačuvaj novu lozinku',
    dugmeUcitavanje: 'Snimanje…',
    zatraziNovi: 'Zatraži novi link',
    validacija: {
    ...
    greskaTokenNevazeci: 'Link je nevažeći.',
    greskaTokenIstekao: 'Link je istekao. Zatraži novi.',
    greskaTokenVecIskoristen: 'Ovaj link je već iskorišten. Zatraži novi ako ti treba reset.',
    greskaOpsta: 'Nešto nije uspjelo. Pokušaj ponovo.',
  },
  registracija: {
    naslov: 'Registracija',
  ...
  admin: {
    ...
    korisnici: {
      ...
      resetLozinke: {
        dugme: 'Pošalji link za reset lozinke',
        slanje: 'Slanje…',
        uspjeh: 'Link je poslan.',
        greskaAdminNalog: 'Nije moguće resetovati lozinku administratorskog naloga kroz ovaj alat.',
        greskaOpsta: 'Slanje nije uspjelo. Pokušaj ponovo.',
      },
    },
    narudzbe: {
      naslov: 'Narudžbe',
